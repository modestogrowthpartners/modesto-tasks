...
function logoBuffer(variant) {
  const files = {
    transparent: "bytech_transparent.png",
    watermark: "bytech_watermark.png",
    footer: "bytech_footer.png",
  };
...
function footerWithLogo() {
  return new Footer({
    children: [new Paragraph({
      ...
      children: [
        new ImageRun({ data: logoBuffer("footer"), transformation: { width: 62, height: 62 * (520/2172) }, type: "png" }),
        new TextRun({ text: "\tBytech  ·  Desenvolvimento de software", font: FONT_CORPO, size: 14, color: CINZA_TEXTO }),
      ],
    })],
  });
}
